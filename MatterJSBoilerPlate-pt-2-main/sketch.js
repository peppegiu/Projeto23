...
function setup() {
	...
	plane = Bodies.rectangle(400,621,12000,20,plane_options);
	...
	particle2 = Bodies.circle(225,10,10,particle_options);
	World.add(world,particle2);
	particle3 = Bodies.circle(230,10,10,particle_options);
	World.add(world,particle3);
	particle4 = Bodies.circle(240,10,10,particle_options);
